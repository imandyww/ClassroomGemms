  ...
  static const _lessonToolSchemas = <Map<String, dynamic>>[
    {
      ...
      'parameters': {
        ...
        'properties': {
          'topic': {
            'type': 'string',
            'description': 'Subject of the lesson, e.g. "photosynthesis".',
          },
          'grade': {
            'type': 'string',
            'description':
          ...
          'numSteps': {
            'type': 'integer',
            'description': 'How many prompts the lesson should contain. Default 3.',
          },
        },
        'required': ['topic'],
      },
    },
    {
      ...
      'parameters': {
        ...
        'properties': {
          'stepIndex': {
            'type': 'integer',
            'description': '0-based index of the step to push. Use 0 for the first step.',
          },
        },
        'required': ['stepIndex'],
      },
    ...
    },
    {
      ...
      'description':
          'Inspect the lesson currently loaded in the authoring pane (title, number of steps, the prompt text for each step). Use this before push_prompt or next_step if you need to know what step you are on.',
      'parameters': {'type': 'object', 'properties': {}},
    },
  ];
  ...
  static Lesson? tryParse({
    ...
    for (var i = 0; i < rawSteps.length; i++) {
      ...
      if (s is Map) {
        ...
        steps.add(LessonStep.create(
          index: steps.length,
          prompt: prompt,
          teacherNotes: (s['teacherNotes'] as String?)?.trim(),
        ));
